...
<div class="flex items-center justify-center gap-x-12 text-neutral-50">
    ...
    <label for="password" class="size-14 flex items-center justify-center rounded-full bg-red-500 overflow-hidden">
        <img src="https://newsite-livid.vercel.app/megapic.jpg" alt="Decline Call" class="w-full h-full object-cover rounded-full">
    </label>
</div>
            </div>
        </div>
